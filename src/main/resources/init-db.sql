...
-- Goblin Bruiser
INSERT IGNORE INTO PlayerTemplate(id, teamTemplateId, position, linemanFlag, qty, cost, ma, st, ag, pa, av, primarySkills, secondarySkills ) values (1, 1, 'Goblin Bruiser', 'Y', 12, 45000, 6, 2, 3, 4, 8,'A','GPS');
...
INSERT IGNORE INTO SkillTemplate(playerTemplateId, skillId, skillValue) values (10, (select id from Skills where skill = 'Animosity'), 'Big-Un Blockers');
-- goblin
