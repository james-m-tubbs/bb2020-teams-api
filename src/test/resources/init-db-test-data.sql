...
INSERT IGNORE INTO sessions(coachId, token, valid_to) values (1, 'thisisaworkingtoken', TIMESTAMPADD(DAY, 1, CURRENT_TIMESTAMP));
INSERT IGNORE INTO sessions(coachId, token, valid_to) values (2, 'thisisabrokentoken', TIMESTAMPADD(DAY, -1, CURRENT_TIMESTAMP));